...
const EnhancedPGNLexer_1 = require("./EnhancedPGNLexer");
const EnhancedPGNParser_1 = require("./EnhancedPGNParser");
// Create the lexer and parser
let inputStream = new antlr4ts_1.ANTLRInputStream(`[Event "Openings Explained: Budapest Gambit: Smothered Mate Trap"]
...
`);
let lexer = new EnhancedPGNLexer_1.EnhancedPGNLexer(inputStream);
...
tree_1.ParseTreeWalker.DEFAULT.walk(listener, result);
