...
class EnhancedPGNLexer extends Lexer_1.Lexer {
    // tslint:enable:no-trailing-whitespace
    constructor(input) {
        super(input);
        this._interp = new LexerATNSimulator_1.LexerATNSimulator(EnhancedPGNLexer._ATN, this);
    }
    // @Override
    // @NotNull
    get vocabulary() {
    ...
    // @Override
    get grammarFileName() { return "EnhancedPGNLexer.g4"; }
    // @Override
    get ruleNames() { return EnhancedPGNLexer.ruleNames; }
    // @Override
    get serializedATN() { return EnhancedPGNLexer._serializedATN; }
    // @Override
    get modeNames() { return EnhancedPGNLexer.modeNames; }
    static get _ATN() {
        if (!EnhancedPGNLexer.__ATN) {
            EnhancedPGNLexer.__ATN = new ATNDeserializer_1.ATNDeserializer().deserialize(Utils.toCharArray(EnhancedPGNLexer._serializedATN));
        }
        return EnhancedPGNLexer.__ATN;
    }
}
EnhancedPGNLexer.TAG_START = 1;
EnhancedPGNLexer.STRING = 2;
EnhancedPGNLexer.MOVE_TEXT_START = 3;
EnhancedPGNLexer.MOVE_TEXT_START_WITH_COMMENT = 4;
EnhancedPGNLexer.NEW_LINE = 5;
EnhancedPGNLexer.TAG_END = 6;
EnhancedPGNLexer.TAG_VALUE = 7;
EnhancedPGNLexer.TAG_KEY = 8;
EnhancedPGNLexer.TAG_SPACE = 9;
EnhancedPGNLexer.EOL_COMMENT_START = 10;
EnhancedPGNLexer.MOVE_NUM = 11;
EnhancedPGNLexer.BLOCK_COMMENT_START = 12;
EnhancedPGNLexer.WS = 13;
EnhancedPGNLexer.PIECE = 14;
EnhancedPGNLexer.LOCATION = 15;
EnhancedPGNLexer.PROMOTION = 16;
EnhancedPGNLexer.RANK = 17;
EnhancedPGNLexer.FILE = 18;
EnhancedPGNLexer.SHORT_CASTLE = 19;
EnhancedPGNLexer.LONG_CASTLE = 20;
EnhancedPGNLexer.CAPTURE_MARKER = 21;
EnhancedPGNLexer.ALTERNATE_LINE_START = 22;
EnhancedPGNLexer.ALTERNATE_LINE_END = 23;
EnhancedPGNLexer.BLUNDER = 24;
EnhancedPGNLexer.MISTAKE = 25;
EnhancedPGNLexer.DUBIOUS_MOVE = 26;
EnhancedPGNLexer.INTERESTING_MOVE = 27;
EnhancedPGNLexer.GOOD_MOVE = 28;
EnhancedPGNLexer.BRILLIANT_MOVE = 29;
EnhancedPGNLexer.CHECK = 30;
EnhancedPGNLexer.CHECKMATE = 31;
EnhancedPGNLexer.WHITE_WINS = 32;
EnhancedPGNLexer.BLACK_WINS = 33;
EnhancedPGNLexer.DRAW = 34;
EnhancedPGNLexer.UNKOWN_ENDING = 35;
EnhancedPGNLexer.NAG = 36;
EnhancedPGNLexer.EOL_COMMENT_TEXT = 37;
EnhancedPGNLexer.EOL_COMMENT_END = 38;
EnhancedPGNLexer.COMMAND_START = 39;
EnhancedPGNLexer.BLOCK_COMMENT_END = 40;
EnhancedPGNLexer.BLOCK_COMMENT_TEXT = 41;
EnhancedPGNLexer.COMMAND_ID = 42;
EnhancedPGNLexer.COMMAND_END = 43;
EnhancedPGNLexer.COMMA = 44;
EnhancedPGNLexer.PARAM_TEXT = 45;
EnhancedPGNLexer.TAG_PAIRS = 1;
EnhancedPGNLexer.MOVE_TEXT = 2;
EnhancedPGNLexer.EOL_COMMENT = 3;
EnhancedPGNLexer.BLOCK_COMMENT = 4;
EnhancedPGNLexer.COMMAND = 5;
EnhancedPGNLexer.COMMAND_PARAMS = 6;
// tslint:disable:no-trailing-whitespace
EnhancedPGNLexer.modeNames = [
    "DEFAULT_MODE", "TAG_PAIRS", "MOVE_TEXT", "EOL_COMMENT", "BLOCK_COMMENT",
    "COMMAND", "COMMAND_PARAMS",
];
EnhancedPGNLexer.ruleNames = [
...
EnhancedPGNLexer._LITERAL_NAMES = [
...
EnhancedPGNLexer._SYMBOLIC_NAMES = [
...
EnhancedPGNLexer.VOCABULARY = new VocabularyImpl_1.VocabularyImpl(EnhancedPGNLexer._LITERAL_NAMES, EnhancedPGNLexer._SYMBOLIC_NAMES, []);
EnhancedPGNLexer._serializedATN = "\x03\uAF6F\u8320\u479D\uB75C\u4880\u1605\u191C\uAB37\x02/\u0127\b\x01" +
...
exports.EnhancedPGNLexer = EnhancedPGNLexer;
//# sourceMappingURL=EnhancedPGNLexer.js.map